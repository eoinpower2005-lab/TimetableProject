...
public abstract class User {
    ...
    /**
     *
     * @param userid the unique id of each of the users
     * @param password the unique password of each the users
     * @param name name of users
     * @param email email of users
     * @param role role of users (student, lecturer, admin)
     * constructs a User object with the passed in parameter
     */
    ...
    /**
     * setters method to set the email of a user
